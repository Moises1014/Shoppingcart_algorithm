    ...
    def getURL():
        ...
        while (choice != '11') and (choice != '22'):
            if choice == '1':
                ...
                website = input('On which site you want to shop ? Only type the domain name (eg: kith.com) ')
        ...
        while (choice != 'y1') and (choice != 'n1'):
            if choice == 'y':
                ...
                try:
                    ...
                    print('')
                    print("(!)Didnt found the size wanted, make sure to put the size as the list is saying  ")
                    print('')
                    print("Try Again.")
                    size = input('Size ?')
                    variant = soup.find(text=size).findPrevious('id').text
                ...
                driver.get(BD)
                [getURL(), getSoup(), getItem(), getSize(), getStock(), getPrice(), getVariants(), getTotal(), formatData(), run()]
            elif choice == 'n':
                    ...
                    while (choice1 != 'yo') and (choice1 != 'no'):
                        if choice1 == 'y':
                            ...
                            print('Ok,the shopify checker is closed')
                            sys.exit()
